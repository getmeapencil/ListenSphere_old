    ...
    return (
        <div className='h-screen flex flex-col justify-center items-center overflow-y-hidden p-0'>
            <div className='flex flex-col justify-center items-center flex-grow'>
                ...
                <Link to="/profile-card" className='my-1 text-center bg-button-green hover:bg-button-green-dark font-bold py-3 px-6 rounded-3xl border-4 border-black'>Show ProfileCard component</Link>
